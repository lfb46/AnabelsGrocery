...
class RecipesView: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    
    var RecipeList = ["Store Hours", "Wednesday 3:00pm - 7:00pm", "Thursday: 3:00pm - 7:00pm", "Friday: 12:00pm - 5:00pm", "Contact Us!",  "607-255-1441",  "anabelgrocery@gmail.com",  "@AnabelsGrocery", "@AnabelsGrocery", "@AnabelsGrocery"]
