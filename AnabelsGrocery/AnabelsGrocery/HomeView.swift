...
class HomeView: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: colvwCell = collectionView.dequeueReusableCell(withReuseIdentifier: "CatCell", for: indexPath) as! colvwCell
        cell.lblCell.text = glovars.categories[indexPath.row]
        cell.imgCell.image = UIImage(named: glovars.categoryPhotos[indexPath.row])
